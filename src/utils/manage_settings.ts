...
export const loadDefaultSettings: Settings = {
    ...
    syncStatus: false, // Default sync status
};
...
export const updateSettings = async (newSettings: Partial<Settings>) => {
    ...
    const updatedSettings: Settings = {
        ...
        syncStatus: newSettings.syncStatus ?? currentSettings.syncStatus ?? loadDefaultSettings.syncStatus,
        ...(newSettings.bookmarks !== undefined ? { bookmarks: newSettings.bookmarks } : currentSettings.bookmarks ? { bookmarks: currentSettings.bookmarks } : {}),
    };
