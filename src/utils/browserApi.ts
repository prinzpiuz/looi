...
export const ext: BrowserAPI | undefined = typedWindow.browser || typedWindow.chrome;
...
export const isFirefox = () =>
  isExtensionEnv() && browser?.runtime.getBrowserInfo().then((info) => info.name === 'Firefox');
export const isChrome = () =>
  isExtensionEnv() && browser?.runtime.getBrowserInfo().then((info) => info.name === 'Chrome');
export const isEdge = () =>
  isExtensionEnv() &&
